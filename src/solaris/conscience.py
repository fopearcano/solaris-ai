...
class Conscience:
    ...
    def __init__(self) -> None:
        ...
        # self.conscience.habit.bias_for). Constructing each module
        # before any module that *calls into* it removes the need
        # for null-checks. After start(), modules talk via the Bus.
