...
For a one-page visual overview of the entire system — five core principles,
the spine, the full module graph, signal vocabulary, Logos opposition,
foundational concepts, and lifecycle — see
**[`Solaris_Ai_SCHEMATIC.svg`](./Solaris_Ai_SCHEMATIC.svg)** (regenerated by
